...
CREATE TABLE `notifications` (
  ...
  KEY `notifications__notification_types__id_IDX1` (`type_id`),
  CONSTRAINT `notification-types__type_id_FK1` FOREIGN KEY (`type_id`) REFERENCES `notification_types` (`type_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
