...
CREATE TABLE `calendar` (
  ...
  KEY `calendar__users_IDX1` (`insert_user_id`),
  CONSTRAINT `calendar__users_FK1` FOREIGN KEY (`insert_user_id`) REFERENCES `users` (`user_id`)
...
-- Dump completed on 2022-01-12 21:39:08
