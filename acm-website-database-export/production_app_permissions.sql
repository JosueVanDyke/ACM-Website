...
CREATE TABLE `app_permissions` (
  ...
  `web_role_id` int(10) unsigned NOT NULL,
  `app_id` int(10) unsigned NOT NULL,
  `insert_date` datetime NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`permission_id`),
  KEY `app_permissions_IDX1` (`app_id`),
  KEY `app_permissions_IDX2` (`web_role_id`),
  CONSTRAINT `app_permissions__applications_FK1` FOREIGN KEY (`app_id`) REFERENCES `applications` (`app_id`),
  CONSTRAINT `app_permissions__web_roles_FK2` FOREIGN KEY (`web_role_id`) REFERENCES `web_roles` (`web_role_id`)
